<template>
      ...
      <n-layout>
        <n-layout-header bordered>
          <span
            ...
            "
          >
            <van-image width="250px" src="/logo.png" style="margin-top: 20px" />
          </span>
                ...
                <n-form ref="regFormRef" :model="regForm" :rules="regRules">
                  ...
                  <n-form-item label="手机号" path="mobile">
                    ...
                    <n-button
                      ...
                      :disabled="
                        regForm.mobile === '' || loading || countdown > 0
                      "
                    >
                      {{
  ...
  const getVerificationCode = async () => {
    ...
    if (!/^(?:(?:\+|00)86)?1(?:(?:3[\d])|(?:4[5-79])|(?:5[0-35-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\d])|(?:9[1589]))\d{8}$/.test(regForm.value.mobile)) {
